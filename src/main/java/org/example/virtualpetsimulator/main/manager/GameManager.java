...
public class GameManager {
    ...
    public void createPet(String name, String type, Long ownerId) {
    ...
    public void importPetsFromFile(String filePath) {
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Long ownerId = Long.parseLong(fields[2]);
                createPet(name, type, ownerId);
            }
            System.out.println("Pets imported successfully!");
        } catch (IOException e) {
